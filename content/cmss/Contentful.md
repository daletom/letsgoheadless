---
title: Contentful
description: 'Empower your Contentful application with module: write in a content/ directory and fetch your Markdown, JSON, YAML and CSV files through a MongoDB like API, acting as a Git-based Headless CMS.'
img: 
alt: Contentful logo
---

This is Contentful. It is a **headless cms**.
