---
title: API Rocket
description: 'Empower your API Rocket application with module: write in a content/ directory and fetch your Markdown, JSON, YAML and CSV files through a MongoDB like API, acting as a Git-based Headless CMS.'
img: 
alt: API Rocket logo
---

This is API Rocket. It is a **headless cms**.
